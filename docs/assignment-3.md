...
In the Jaeger UI you can the find cronmail endpoint call by the Dapr cron job. You will also see the call to the Dapr SMTP output binding by the cronmail endpoint.
